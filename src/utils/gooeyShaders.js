// 移植自 https://github.com/Aqro/gooey-hover-codrops (src/glsl/gooeyShader.glsl)
// 工程用 Vite 无 glslify,把 `#pragma glslify: snoise3 = require('glsl-noise/simplex/3d')`
// 替换为内联的 Ashima/glsl-noise 3D simplex noise(原函数名 snoise → snoise3)。
...
// glsl-noise simplex/3d (Ian McEwan, Ashima Arts, MIT)
const SNOISE3 = `
